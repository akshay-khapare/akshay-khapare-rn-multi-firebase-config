...
const useFirestoreGetQuery = () => {
     ...
     */
    const getQuery = async ({ collection, firebaseProjectName, where, orderBy, limit, startAt, startAfter, endAt, endBefore, }, options) => {
        let query = (0, Firebase_1.firestore)(firebaseProjectName).collection(collection);
        // Apply where clauses
        where === null || where === void 0 ? void 0 : where.forEach(([field, op, value]) => {
            query = query.where(field, op, value);
        });
        // Apply ordering
        orderBy === null || orderBy === void 0 ? void 0 : orderBy.forEach(([field, direction]) => {
        ...
        const snapshot = await query.get({
            source: (options === null || options === void 0 ? void 0 : options.source) || "default",
        });
